                                    ...
                                    >
                                        ...
                                        >
                                            <div className="flex flex-row justify-center items-center">
                                                <img src="/icons/landing-page/decks/star.svg" alt="Star" width={16} height={16} style={{ verticalAlign: 'middle', marginRight: 4 }} />
                                                {deck.numStars} ({deck.numReviews}){' '}
                                                <img src="/icons/landing-page/decks/dot.svg" alt="Dot" width={4} height={4} style={{ verticalAlign: 'middle', margin: '0 4px' }} />{' '}
                                                <img src="/icons/landing-page/decks/book.svg" alt="Book" width={16} height={16} style={{ verticalAlign: 'middle', marginRight: 4 }} />
                                                {deck.numStudiers} studiers
                                            </div>
                                            <div className="flex flex-row">
                                                <img src="/icons/landing-page/decks/deck.svg" alt="Deck" width={16} height={16} style={{ verticalAlign: 'middle', marginRight: 4 }} />
                                                {deck.numCards}
                                            </div>
                                        </div>
