...
export default function HeroSection() {
  return (
    <section className="pt-5 lg:pt-10 container mx-auto mb-16 md:mb-32">
      {/* Mobile Layout */}
      <div className="flex flex-col lg:hidden items-center justify-center gap-14 min-h-[450px]">
        ...
        <div className="flex flex-col gap-6 justify-center items-center text-center px-6 mt-12">
          <div>
            <h1 className="text-primary font-bold" style={{ fontSize: 36 }}>Flashcards,</h1>
            <ColorInterpolation className="text-4xl font-bold bg-clip-text text-transparent leading-[1.15]">Reimagined</ColorInterpolation>
          </div>
          <p className="text-primary" style={{ fontSize: 16 }}>Stylish, smart, and completely customizable.</p>
          <Link
            href="/auth/register"
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-10 md:gap-20 lg:gap-32 min-h-[450px]">
          <div className="flex flex-col gap-4 justify-center">
            <div>
              ...
              <ColorInterpolation className="text-7xl font-bold bg-clip-text text-transparent leading-[1.15]">Reimagined</ColorInterpolation>
            </div>
            <p className="text-primary text-xl text-center md:text-left">Stylish, smart, and completely customizable.</p>
            <Link
              href="/auth/register"
              className="w-fit font-bold text-xl text-white px-8 py-4 rounded-full transition-all duration-200 border-2 border-white cursor-pointer bg-gradient-to-r bg-[#007CB5] hover:from-[#007CB5] hover:from-0% hover:via-[#369DE3] hover:via-67% hover:to-[#BCADF2] hover:to-100% hover:shadow-lg"
            >
